			...
			var promises = files.map(function (filename) {
				...
				return queue.add(function (fulfil, reject) {
					...
					return sander.readFile(src).then(function (buffer) {
						// Convert the result of the read operation into a string of the encoding specified in
						// options.sourceEncoding. Pass 'buffer' as an option to leave it as a buffer.
						var encoding = transformOptions.sourceEncoding;
						if (!encoding) return buffer.toString();
